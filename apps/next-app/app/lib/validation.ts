...
export function validateDeadlineOrder(
...
export function validateTimeslotDuration(
	startTime: string,
	endTime: string,
	_minMinutes: number = 30
): string | null {
...
export function validateGuestListDeadline(
	guestDate: string,
	eventDate: string
): {
	isValid: boolean;
...
export function validatePromoDeadline(
	promoDate: string,
	eventDate: string
): {
	isValid: boolean;
