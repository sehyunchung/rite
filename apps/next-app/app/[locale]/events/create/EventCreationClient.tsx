      ...
      <div className="p-4 md:p-8">
        <div className="max-w-7xl mx-auto">
          <div className="mb-6 md:mb-8">
            <Typography variant="h1" className="text-2xl md:text-3xl">{tEvents('title')}</Typography>
            <Typography variant="body-lg" color="secondary" className="mt-2">{tEvents('subtitle')}</Typography>
          </div>
