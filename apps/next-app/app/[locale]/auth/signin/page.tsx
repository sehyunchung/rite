		...
		<div className="min-h-screen bg-bg-primary flex items-center justify-center py-12 px-4">
			<div className="max-w-md w-full space-y-12">
				<div className="text-center">
					<Typography variant="h1" className="text-5xl text-brand-primary">
						RITE
					</Typography>
					<Typography variant="body-lg" color="secondary" className="mt-4">
						{t('tagline')}
					</Typography>
				</div>
				...
				<Card>
					...
					<CardContent className="space-y-4">
						...
						<div className="mt-4 p-3 bg-color-info/10 border border-color-info/20 rounded-lg">
							<Typography variant="body-sm" className="text-color-info font-medium mb-1">
								{t('mobileGuidance.title')}
							</Typography>
							<Typography variant="body-sm" className="text-color-info">
								{t('mobileGuidance.message')}
							</Typography>
