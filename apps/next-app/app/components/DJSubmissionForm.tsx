...
export function DJSubmissionForm({ submissionToken }: DJSubmissionFormProps) {
	...
	useEffect(() => {
		if (timeslotData?.existingSubmission) {
			...
			// Populate guest list
			const existingGuests = submission.guestList.map(
					...
					<CardContent className="space-y-4">
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
							...
							<div className="bg-neutral-700 p-4 rounded-lg">
								<Typography variant="h6" className="text-brand-primary mb-2">
									{t('yourTimeSlot')}
								</Typography>
								<Typography variant="body" className="text-brand-primary-light">
									{startTime} - {endTime}
								</Typography>
								<Typography variant="body" className="text-brand-primary-light">
									DJ: {djName}
						...
						<div className="bg-yellow-500/10 border border-yellow-500/20 p-4 rounded-lg">
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-2">
								<Typography variant="body" className="text-warning">
									<span className="font-semibold">{t('guestList')}:</span>{' '}
									{event.deadlines.guestList}
								</Typography>
								<Typography variant="body" className="text-warning">
									<span className="font-semibold">{t('promoMaterials')}:</span>{' '}
				...
				<form onSubmit={(e) => void handleSubmit(e)} className="space-y-8">
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>{t('promoMaterialsDescription')}</CardDescription>
						</CardHeader>
						<CardContent className="space-y-4">
							<Dropzone
								src={promoFiles}
							...
							>
								...
								<DropzoneEmptyState>{t('dropFilesHere')}</DropzoneEmptyState>
							</Dropzone>
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>{t('guestListDescription')}</CardDescription>
						</CardHeader>
						<CardContent className="space-y-4">
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>{t('djContactDescription')}</CardDescription>
						</CardHeader>
						<CardContent className="space-y-4">
							<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
								<div className="space-y-2">
