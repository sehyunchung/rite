        ...
        <CardContent>
          <div className="space-y-3">
            <div className="grid grid-cols-2 gap-2 text-sm">
              ...
              <div className="flex items-center gap-2">
                <span className="text-muted-foreground">{t('capabilities.canAcceptSubmissions')}:</span>
                <span className={capabilities?.canAcceptSubmissions ? 'text-green-600' : 'text-gray-400'}>
                  {capabilities?.canAcceptSubmissions ? '✓' : '✗'}
                </span>
              </div>
              {capabilities?.showDayOfFeatures && (
                <div className="col-span-2 flex items-center gap-2">
                  <span className="text-muted-foreground">{t('capabilities.dayOfFeaturesActive')}:</span>
