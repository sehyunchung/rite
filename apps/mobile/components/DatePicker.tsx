    ...
    return (
      <View className={className}>
        ...
        <input
          ...
          aria-label={accessibilityLabel || `Date selector. Currently selected: ${formatDate(value)}`}
  ...
  return (
    <View className={className}>
      ...
      <TouchableOpacity
        ...
        accessibilityLabel={accessibilityLabel || `Date selector. Currently selected: ${formatDate(value)}`}
