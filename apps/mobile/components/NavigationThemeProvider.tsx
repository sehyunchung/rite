  ...
  const navigationTheme = React.useMemo(() => {
    ...
    return {
      ...
      colors: {
        ...
        background: themeData.type === 'dark' ? themeData.neutral[800] : themeData.functional.backgroundSubtle,
        card: themeData.type === 'dark' ? themeData.neutral[700] : themeData.functional.backgroundElevated,
