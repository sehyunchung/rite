...
export const mockMutation = vi.fn().mockImplementation(
...
export const mockQuery = vi.fn().mockImplementation(
  async (name: string, args: any) => {
    // Default mock implementations
    switch (name) {
      case 'events.list':
...
export const mockAction = vi.fn().mockImplementation(
  async (name: string, args: any) => {
    // Default mock implementations
    return { success: true }
  }
...
// Mock useQuery hook
export const mockUseQuery = vi.fn().mockImplementation(
...
export const mockUseMutation = vi.fn().mockImplementation(
  (name: string) => {
    return mockMutation
  }
)
...
// Mock useAction hook
export const mockUseAction = vi.fn().mockImplementation(
  (name: string) => {
    return mockAction
  }
)
