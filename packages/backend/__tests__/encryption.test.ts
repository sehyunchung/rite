...
describe('Encryption Functions', () => {
	...
	describe('Error Handling', () => {
		...
		it('should throw error for invalid encrypted data format', () => {
			...
			expect(() => decryptSensitiveData('invalid-data')).toThrow(
				'Expected ENC_V2_ or ENC_V1_ prefix'
			);
		});
	});
	...
	describe('Migration', () => {
		...
		it('should throw error when trying to migrate non-V1 data', () => {
			expect(() => migrateEncryptionV1ToV2('ENC_V2_somedata')).toThrow(
				'Cannot migrate non-V1 data'
			);
