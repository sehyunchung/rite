...
export const H1 = React.forwardRef<RNText, TextProps>(({ className, ...props }, ref) => (
	<Text ref={ref} variant="h1" className={className} {...props} />
));
H1.displayName = 'H1';

export const H2 = React.forwardRef<RNText, TextProps>(({ className, ...props }, ref) => (
	<Text ref={ref} variant="h2" className={className} {...props} />
));
H2.displayName = 'H2';

export const H3 = React.forwardRef<RNText, TextProps>(({ className, ...props }, ref) => (
	<Text ref={ref} variant="h3" className={className} {...props} />
));
H3.displayName = 'H3';

export const H4 = React.forwardRef<RNText, TextProps>(({ className, ...props }, ref) => (
	<Text ref={ref} variant="h4" className={className} {...props} />
));
H4.displayName = 'H4';

export const H5 = React.forwardRef<RNText, TextProps>(({ className, ...props }, ref) => (
	<Text ref={ref} variant="h5" className={className} {...props} />
));
H5.displayName = 'H5';

export const H6 = React.forwardRef<RNText, TextProps>(({ className, ...props }, ref) => (
	<Text ref={ref} variant="h6" className={className} {...props} />
));
H6.displayName = 'H6';

export const Body = React.forwardRef<RNText, TextProps>(({ className, ...props }, ref) => (
	<Text ref={ref} variant="body" className={className} {...props} />
));
Body.displayName = 'Body';

export const BodyLarge = React.forwardRef<RNText, TextProps>(({ className, ...props }, ref) => (
	<Text ref={ref} variant="bodyLarge" className={className} {...props} />
));
BodyLarge.displayName = 'BodyLarge';

export const BodySmall = React.forwardRef<RNText, TextProps>(({ className, ...props }, ref) => (
	<Text ref={ref} variant="bodySmall" className={className} {...props} />
));
BodySmall.displayName = 'BodySmall';

export const Caption = React.forwardRef<RNText, TextProps>(({ className, ...props }, ref) => (
	<Text ref={ref} variant="caption" className={className} {...props} />
));
Caption.displayName = 'Caption';

export const TextLabel = React.forwardRef<RNText, TextProps>(({ className, ...props }, ref) => (
