...
export const themes = {
  ...
  joshComeau: {
    ...
    functional: {
      ...
      backgroundElevated: 'hsl(210deg 25% 25%)', // #383845 - Lighter than bg-primary for elevation
  ...
  joshComeauLight: {
    ...
    type: 'light' as const,
    brand: {
      primary: 'hsl(225deg 100% 65%)',      // #6666FF - Slightly darker for better contrast on light bg
      primaryDark: 'hsl(225deg 100% 50%)',  // #4C4CFF
      primaryLight: 'hsl(225deg 100% 75%)', // #7C7CFF
    },
    neutral: {
      0: 'hsl(210deg 15% 6%)',      // #0F0F10 - Inverted for inverse text
      50: 'hsl(210deg 15% 12%)',    // #1A1A1F
      100: 'hsl(210deg 15% 18%)',   // #26262E
      200: 'hsl(210deg 10% 30%)',   // #47474D
      300: 'hsl(210deg 9% 40%)',    // #616166
      400: 'hsl(210deg 8% 50%)',    // #70707F
      500: 'hsl(210deg 12% 55%)',   // #8C8CA3
      600: 'hsl(210deg 14% 66%)',   // #A8A8BD
      700: 'hsl(210deg 20% 77%)',   // #C4C4D1
      800: 'hsl(210deg 25% 88%)',   // #DDDDE5
      900: 'hsl(210deg 25% 96%)',   // #F5F5F8
    },
    semantic: {
      success: 'hsl(160deg 100% 30%)',  // #009950 - Darker for light mode
      warning: 'hsl(40deg 100% 40%)',   // #CC9900
      error: 'hsl(340deg 95% 50%)',     // #FF1A4D
      info: 'hsl(225deg 100% 60%)',     // #5C5CFF
    },
    functional: {
      textPrimary: 'hsl(210deg 15% 12%)',     // #1A1A1F - Dark text for light mode
      textSecondary: 'hsl(210deg 10% 30%)',   // #47474D
      textMuted: 'hsl(210deg 8% 50%)',        // #70707F
      textDisabled: 'hsl(210deg 12% 55%)',    // #8C8CA3
      textInverse: 'hsl(210deg 25% 96%)',     // #F5F5F8 - Light text for dark backgrounds
      
      border: 'hsl(210deg 20% 77%)',          // #C4C4D1 - Light borders
      borderStrong: 'hsl(210deg 14% 66%)',    // #A8A8BD
      borderSubtle: 'hsl(210deg 25% 88%)',    // #DDDDE5
      
      divider: 'hsl(210deg 20% 77%)',         // #C4C4D1
      overlay: 'hsl(210deg 15% 12% / 0.75)',  // #1A1A1FBF - Dark overlay
      
      backgroundElevated: 'hsl(210deg 25% 88%)', // #DDDDE5 - Cards/elevated surfaces
      backgroundSubtle: 'hsl(210deg 25% 96%)',   // #F5F5F8 - Page background
    },
    interactive: {
      hover: 'hsl(225deg 100% 65% / 0.1)',
      active: 'hsl(225deg 100% 65% / 0.15)',
      focus: 'hsl(225deg 100% 65%)',
      disabled: 'hsl(210deg 14% 66%)',
    },
    accent: 'hsl(333deg 100% 45%)',        // #E6007A - Slightly darker for light mode
    tertiary: 'hsl(280deg 100% 75%)',      // #CC99FF
    decorative: 'hsl(200deg 50% 50%)',     // #5599AA
    action: 'hsl(240deg 95% 52%)',         // #3D3DFF
    atmospheric: {
      skyFrom: 'hsl(214deg 40% 89%)',      // #E0E0F0 - Light sky
      skyTo: 'hsl(200deg 50% 70%)',        // #8CBBD9
      skySubtle: 'hsl(210deg 40% 84%)',    // #D9D9E6
      cloudLight: 'hsl(212deg 40% 91%)',   // #E8E8F0
      cloudMedium: 'hsl(213deg 40% 90%)',  // #E5E5ED
      cloudDark: 'hsl(213deg 40% 88%)',    // #DFDFEA
    },
  },
};
